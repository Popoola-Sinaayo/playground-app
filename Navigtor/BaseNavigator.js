...
import { WelcomeScreen, SecondScreen, ThirdScreen, Measure, Playground, Setting } from "../Screens";
import { Ionicons, FontAwesome, Fontisto, MaterialCommunityIcons, Entypo } from '@expo/vector-icons';
...
function MyTabs() {
  ...
  const Left = () => (
    <Pressable onPress={() => navigate.goBack()} style={{ flexDirection: "row", gap: 5, alignItems: "center" }}>
  ...
  const Right = () => (
    <View style={{ flexDirection: "row", gap: 1, alignItems: "center", paddingRight: 10 }}>
  ...
  return (
    <Tab.Navigator screenOptions={{ tabBarActiveTintColor: "#F58220" }}>
      ...
      />
      <Tab.Screen name="Measures" component={Measure}
        options={{
          headerTitleAlign: "center", headerLeft: () => (
            <Left />
          ),

          tabBarIcon: (props) => <MaterialCommunityIcons name="star-circle" {...props} />,
        }}
      />
      <Tab.Screen name="Playgrounds" component={Playground}
        options={{
          headerTitleAlign: "center", headerLeft: () => (
            <Left />
          ),
      ...
      <Tab.Screen name="Settings" component={Setting}
        options={{
          ...
          tabBarIcon: (props) => <MaterialCommunityIcons name="notebook" {...props} />,
        }}
      />
    </Tab.Navigator>
  );
